...
#
# Defaults: --org saas-customization, --project-dir current dir, --ignore-conflicts always on.
# Notes: source-tracking may reject a shared object with a "../AccountingCloud … unsafe" path —
#        pass --metadata "ApexClass:Name" instead when that bites. Needs the `sf` CLI + python3.
set -euo pipefail

ORG="saas-customization"
PROJECT_DIR="$PWD"
TESTS=""
