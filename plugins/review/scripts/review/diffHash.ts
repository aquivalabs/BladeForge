 ...
 * attestation as a human/bot-readable pointer and the anchor for the next incremental review
 * (`git diff <commitSha>..HEAD` = what changed since). Not the gate's validity key — that stays
 * the content-based diffHash. */
