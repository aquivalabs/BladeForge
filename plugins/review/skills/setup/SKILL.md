...
| Salesforce / Apex | `salesforce:apex_test-authoring` → tests · `salesforce:security_review-rules` → security · `salesforce:data-router`, `salesforce:ui_config-architecture` → architecture |
