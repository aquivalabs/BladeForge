...
Iterative, user-refined skill. Seed comes from the FS-14711 prompt-storage diagram (v1→v4). The
...
3. **Recurse over STRUCTURE, not types — until 0 new entities.** Expanding an entity's "made of" /
   ...
   - A relation to an **external** entity (platform, `AcctSeed` core, third-party, anything out of
